...
import decisionTree from "../assets/DecisionTree.gif"
import predictiveModel from "../assets/PredictiveModel.gif"
import geneticAlgo from "../assets/GeneticAlgorithm.gif"
import loan from "../assets/LoanManagment.gif"

function Projects(){
    return (
        <div>
            <Container style={{ display: 'flex', alignItems: 'center', justifyContent: "center" }}>
            <Image h={150} w="auto" src={decisionTree} style={{ marginRight: 20 }} radius="md" />
                <Group>
                    <div>
            ...
            <Image h="auto" w={260} src={predictiveModel} style={{ marginRight: 20 }} radius="md" />
                <Group>
                    <div>
            ...
            <Container mt={50} style={{ display: 'flex', alignItems: 'center', justifyContent: "center" }}>
            <Image h="auto" w={260} src={geneticAlgo} style={{ marginRight: 20 }} radius="md" />
                <Group>
                    <div>
            ...
            <Container mt={50} style={{ display: 'flex', alignItems: 'center', justifyContent: "center" }}>
            <Image h="auto" w={260} src={loan} style={{ marginRight: 20 }} radius="md" />
                <Group>
                    <div>
