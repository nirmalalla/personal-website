    ...
    return (
        <div>
            <Container style={{ display: 'flex', alignItems: 'center', justifyContent: "center" }}>
                <Group>
                    <Image h={150} w="auto" src="personal-website\src\assets\DecisionTree.gif" style={{ marginRight: 20 }} radius="md" />
                    <div>
            ...
            <Container mt={50} style={{ display: 'flex', alignItems: 'center', justifyContent: "center" }}>
                <Group>
                    <Image h="auto" w={260} src="personal-website\src\assets\PredictiveModel.gif" style={{ marginRight: 20 }} radius="md" />
                    <div>
            ...
            <Container mt={50} style={{ display: 'flex', alignItems: 'center', justifyContent: "center" }}>
                <Group>
                    <Image h="auto" w={260} src="personal-website\src\assets\GeneticAlgorithm.gif" style={{ marginRight: 20 }} radius="md" />
                    <div>
            ...
            <Container mt={50} style={{ display: 'flex', alignItems: 'center', justifyContent: "center" }}>
                <Group>
                    <Image h="auto" w={260} src="personal-website\src\assets\LoanManagment.gif" style={{ marginRight: 20 }} radius="md" />
                    <div>
